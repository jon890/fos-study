...
두 달 걸렸다. 예상보다 오래 걸린 이유는 **Gateway가 조용히 해주던 일이 생각보다 많았고**, 걷어낸 자리를 하나씩 채우다 보니 매번 처음 보는 계층에 걸렸기 때문이다. 이 글은 그 과정의 기록이다. 개별 기술 내용은 따로 정리해 뒀으니 여기서는 **무엇을 왜 했고 어디서 막혔는지**에 집중한다.
...
> 이 세 가지의 상세는 [API Gateway를 걷어낸 자리 채우기](../../devops/k8s/api-gateway-removal-rewrite-and-https.md)에 정리했다.
