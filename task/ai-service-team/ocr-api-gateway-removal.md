...
세 달 걸렸다. 예상보다 오래 걸린 이유는 **Gateway가 조용히 해주던 일이 생각보다 많았고**, 제거한 자리를 하나씩 채우다 보니 매번 처음 보는 계층에 걸렸기 때문이다. 이 글은 그 과정의 기록이다. 개별 기술 내용은 따로 정리해 뒀으니 여기서는 **무엇을 왜 했고 어디서 막혔는지**에 집중한다.
...
**운영 환경까지 전환을 마쳤다.** 기존 경로는 의도적으로 함께 열어 두었다. 고객이 호출 주소를 바꿔야 하는 변경이라 충분한 유예를 두기로 했다.
