...
| 2026.06–2026.08 | OCR 공인 진입점 전환: API Gateway 제거, 공인 LB·Ingress 직접 노출, 경로 변환·HTTPS·IP 접근 제어 | [API Gateway를 제거하고 공인 LoadBalancer로 직접 노출하기](ocr-api-gateway-removal.md) |
