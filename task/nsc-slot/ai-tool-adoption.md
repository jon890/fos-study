...
│   ├── nsc_00000036-rules.mdc  # Slot 36 (라인 + 코인 레벨링) 전용 규칙
│   ├── nsc_00000041-rules.mdc  # Slot 41 (빙고 메커니즘) 전용 규칙
│   ├── nsc_00000047-rules.mdc  # Slot 47 (웨이(243) + Sync Reel) 전용 규칙
│   └── ... (슬롯별 10종 이상)
...
| 작업 | 결과 |
|------|------|
| Slot 44 (라인 + 프리스핀/리트리거) 초기 구현 | 에이전트 단독 구현 |
| Slot 41 (빙고 메커니즘) 전체 구현 | 에이전트 단독 구현 |
| Slot 47 (웨이(243) + Sync Reel) 전체 구현 | 에이전트 단독 구현 |
