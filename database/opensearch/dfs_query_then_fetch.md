...
## 배경: 분산 환경에서의 스코어링 문제 (Scoring Bias)
...
## 해결책: DFS (Distributed Frequence Search) Query Then Fetch
...
#### RAG 시스템에서의 특수성 (Keyword vs Vector)
...
#### "DFS Query Then Fetch" 대신 사용하는 현대적 RAG 패턴
