...
두 방식의 약점을 보완하기 위해 **Hybrid Search**가 등장했다. 그리고 Hybrid Search로 많이 수집한 결과에서 진짜 관련 문서를 추리기 위해 **Reranking**을 붙인다. 거기에 더해 청크 단위 검색의 컨텍스트 단절 문제를 해결하는 **Sentence Window** 기법까지, 세 가지를 차례로 살펴본다.
