...
→ 캐싱 전략 상세: [캐시 설계 전략 총정리](../../architecture/distributed-systems/cache-strategies.md)
...
- [캐시 설계 전략 총정리](../../architecture/distributed-systems/cache-strategies.md) — Look-Aside, Read-Through, Write-Through, Write-Behind 등 캐시 패턴 상세
