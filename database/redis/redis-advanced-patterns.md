...
캐시 스탬피드는 [`cache-aside.md`](cache-aside.md)에 상세 설명이 있다. 여기서는 **어느 상황에 어느 해법을 고르는지**만 정리한다.
...
[`operations.md`](operations.md)에 진단 명령어가 있지만, **개념 정의와 대응 설계**는 여러 문서에 분산되어 있어 허브에서 통합한다.
