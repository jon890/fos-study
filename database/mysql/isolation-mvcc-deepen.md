...
### "START TRANSACTION 시점에는 Read View가 만들어지지 않는다"
...
### 한 트랜잭션 안의 SELECT와 UPDATE가 어긋나는 메커니즘
...
### InnoDB RR에서 Write Skew가 살아남는 이유
...
### "물질화 충돌(Materializing Conflicts)" 패턴
...
## Semi-Consistent Read — RC만의 UPDATE 매칭 동작
...
## UPDATE의 WHERE 조건은 어느 시점의 데이터에 적용되는가
...
### `Propagation.REQUIRES_NEW`와 격리수준
...
### 실습 3 — Semi-Consistent Read 효과 비교
