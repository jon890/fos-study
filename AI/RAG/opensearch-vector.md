...
## OpenSearch 구조 간단 정리 (로그/매트릭이랑 같은 개념)
...
## 벡터용 OpenSearch: k-NN 플러그인 + `knn_vector`
...
## OpenSearch를 벡터 스토어로 운영할 떄 중요한 점
