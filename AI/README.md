...
- [LangGraph로 에이전트 워크플로 만들기 (시리즈)](./langgraph/langgraph-learning-roadmap.md) — Java 백엔드 관점의 9편 (아래 목록 참고)
...
Java 백엔드 관점에서 LangGraph를 처음부터 익히고 Spring AI 2 연동과 실무 운영까지 9편으로 정리했다.
...
7. [LangGraph4j와 Spring AI 2 연동](./langgraph/langgraph4j-spring-ai-llm-tools.md) — 모델 경계, 구조화 출력, 도구 호출과 스트리밍
8. [LangGraph4j 실무 운영](./langgraph/langgraph4j-production-operations.md) — 영속 체크포인트, 하위 그래프, 관찰 가능성과 배포 호환성
9. [학습 로드맵](./langgraph/langgraph-learning-roadmap.md) — 읽는 순서와 단계별 실습 과제
