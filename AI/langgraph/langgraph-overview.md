...
1. 이 글에서 State, Node, Edge와 Graph의 전체 실행 순서를 본다.
...
브라우저에는 [LangGraph 학습 로드맵](./langgraph-learning-roadmap.md)을 띄우고, 편집기에는 [LangGraph4j in Action 저장소](https://github.com/jon890/langgraph4j-in-action)를 연다.
개념과 따라 하기 흐름은 블로그에서 읽고, 저장소에서는 코드만 작성한다.
