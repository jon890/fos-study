...
- **이게 실제로 Codex가 아주 잘하는 규칙 기반 행동**이다
...
- Claude Code, Cursor, Gemini, Codex, Continue.dev 등 AI 툴들 전부가 **텍스트 기반 컨텍스트를 제공하면 지침을 따르는 구조**로 작동한다
...
- [agents.md를 효과적으로 작성하는 방법 : 2500개가 넘는 레포지터리를 통해 얻은 교훈](https://github.blog/ai-and-ml/github-copilot/how-to-write-a-great-agents-md-lessons-from-over-2500-repositories/)
- Chatgpt와의 대화
