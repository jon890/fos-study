# 시니어 백엔드를 위한 보안 / 인증 스터디 팩 — Spring Security, JWT, OAuth2, OWASP Top 10
...
## Access Token vs Refresh Token, 회전, 탈취 대응
...
## OAuth2 Authorization Code + PKCE, OIDC 차이
...
## Spring Security 필터 체인과 인증/인가 분리
...
## API Gateway 인증 종료 vs 서비스 내부 재검증
...
## 실행 가능한 예제 — JWT 발급/검증 + Refresh Rotation
