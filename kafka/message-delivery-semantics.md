...
- [분산 트랜잭션과 Outbox 패턴](../architecture/distributed-transaction-outbox-pattern.md) — Transactional Outbox의 구체 구현
- [Kafka 데이터 정합성 설계](./data-consistency.md) — Exactly-once 실전
- [Kafka 실전 설계](./kafka-design.md) — 파티션/컨슈머 그룹 설계
